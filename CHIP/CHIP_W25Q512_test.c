...
{
    HDL_G4_Flash_read(HDL_G4_Flash_get_address_by_sector(40), &var, 1);
    var++;
    HDL_G4_Flash_write(HDL_G4_Flash_get_address_by_sector(40), &var, 1);
...
void CHIP_W25Q512_QFS_test()
{
    ...
    while (1)
    {
        ...
        // // 1s 执行一次
        // if ((HDL_G4_CPU_Time_GetTick() - cpu_tick) > 100)
        // {
