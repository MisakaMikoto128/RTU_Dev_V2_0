...
/********************************************************
*函数名：HDL_G4_ADC_Enable()
*功能说明：启动双重ADC，定时器触发转换，DMA运输
*形参：无
*返回值：无
*说明：函数放在HDL_G4_ADC_Init后面
********************************************************/
void HDL_G4_ADC_Enable()
{
...
/********************************************************
*函数名：HDL_G4_ADC_Vaule(uint16_t *adc1_Value,uint16_t *adc2_Value)
*功能说明：计算ADC1的采集的数据和ADC2采集的数据
*形参：uint16_t *adc1_Value存放ADC1的值，uint16_t *adc2_Value存放ADC2的值，单位mV
*返回值：无
*说明：函数放在循环中
********************************************************/
void HDL_G4_ADC_Vaule(uint16_t *adc1_Value,uint16_t *adc2_Value)
{
