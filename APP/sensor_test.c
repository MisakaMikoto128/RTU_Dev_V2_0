...
void sensor_testt()
{
    ...
    while (1)
    {
        ...
        if (period_query(0, 1000))
        {
            ...
            {
                LOG(LOG_DEBUG, "Modbus 3 Send Failed! 0x04\r\n");
            }
        }
            ...
            if (modbus_rtu_host_match_ack_event(hModbusRTU3, 0x03, MODBUS_RTU_ANY_ADDRESS))
            {
                ...
                {
                    {
                        ...
                        {
                            LOG(LOG_DEBUG, "Modbus 3 Send Failed 0x08!\r\n");
                        }
                    }
                    break;
                }
                ...
                case 0x08:
                {

                    {
                        ...
                        {
                            LOG(LOG_DEBUG, "Modbus 3 Send Failed 0x06!\r\n");
                        }
                    }
                    break;
                }
                ...
                {
                    {
                        ...
                        LOG(LOG_DEBUG, "[sensor test] P:%.3f fi_white : %.2f,"\
                        "fi_green : %.2f,fi_red : %.2f!", P,fi_white * 0.1f,fi_green * 0.1f,fi_red * 0.1f);
                    }
                    break;
                }
                }
