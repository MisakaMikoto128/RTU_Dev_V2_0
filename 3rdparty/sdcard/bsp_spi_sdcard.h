...
#define SD_CS_GPIO_CLK()      LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB)

#define SD_DETECT_Pin       LL_GPIO_PIN_11
#define SD_DETECT_GPIO_Port GPIOB
#define SD_DETECT_EXTI_IRQn EXTI15_10_IRQn
#define SD_DETECT_GPIO_CLK()  LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB)
