...
void SD_SingleBlockTest(void)
{
    ...
    if (TransferStatus1 == PASSED) {
        ULOG_INFO("Single block 测试成功！");
    } else {
        ULOG_INFO("Single block 测试失败，请确保SD卡正确接入开发板，或换一张SD卡测试！");
    }
}
...
void SD_MultiBlockTest(void)
{
    ...
    if (TransferStatus2 == PASSED) {
        ULOG_INFO("Multi block 测试成功！");
    } else {
        ULOG_INFO("Multi block 测试失败，请确保SD卡正确接入开发板，或换一张SD卡测试！");
    }
}
